...
const VIDEO_CODECS = ['H264', 'VP9', 'VP8', 'AV1']
    ...
    <div className={styles.root}>
      <div className={styles.cols}>
        ...
        <div className={styles.col}>
          <label className={styles.label} htmlFor="video-codec">video codec</label>
          <Select
            id="video-codec"
        ...
        {/* Audio codec column */}
        <div className={styles.col}>
          <label className={styles.label} htmlFor="audio-codec">audio codec</label>
          <Select
            id="audio-codec"
